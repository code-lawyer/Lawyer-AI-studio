...
SuitAgent 是基于 Codex 架构的**基于agents法律科技系统**，支持：
...
> 详细工作流定义请参阅：[`.Codex/rules/WorkflowSystem.md`](.Codex/rules/WorkflowSystem.md)
> 详细场景识别规则及案件模板结构请参阅：[`.Codex/rules/AgentMapping.md`](.Codex/rules/AgentMapping.md)
...
- **项目文档** (`docs/`, `status/`, `.Codex/`): 记录项目自身的更新和改进
...
> 更多详细配置请参阅：
>
> - `.Codex/rules/` 目录下的规则配置文件
> - `.Codex/agents/` 目录下的各组件配置文件（10个Agent的详细说明）
> - `output/` 目录下的文档管理结构
