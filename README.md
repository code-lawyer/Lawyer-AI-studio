...
| 安装方式           | 是否需要先安装 Node.js       |
| ------------------ | ---------------------------- |
| Homebrew (macOS)   | ❌ 不需要                    |
| 官方安装脚本       | ❌ 不需要                    |
| Windows PowerShell | ❌ 不需要                    |
| NPM 全局安装       | ✅**需要** Node.js 18+ |

> **💡 提示**：除了NPM安装方式外，其他方式已内置Node.js运行时，无需单独安装。
...
推荐使用国内大模型公司的 **CodePlan订阅** 服务：

- **[智谱 GLM Coding 订阅](https://www.bigmodel.cn/glm-coding?ic=GQ7UADJJF1)** - GLM-4.7 ⭐⭐⭐⭐⭐
- **[MiniMax Coding Plan 订阅](https://platform.minimaxi.com/subscribe/coding-plan?code=3VCVnwZP1O&source=link)** - MiniMax-M2.1 ⭐⭐⭐⭐⭐

#### 2️⃣ 配置工具（推荐）

**强烈推荐使用 cc-switch 图形化配置工具**，无需手动编辑配置文件：
...
1. **启动应用**：从启动台或应用程序文件夹中打开cc-switch
2. **选择模型**：在应用中点击选择AI模型服务商
3. **输入密钥**：粘贴您的API密钥
4. **保存配置**：点击保存，无需手动编辑配置文件
...
**A**: SuitAgent 推荐使用 CodePlan 订阅服务，享受更优质的开发体验：

- **[智谱AI（GLM-4.7）](https://www.bigmodel.cn/glm-coding?ic=GQ7UADJJF1)** - 推荐⭐⭐⭐⭐⭐
- **[MiniMax（MiniMax-M2.1）](https://platform.minimaxi.com/subscribe/coding-plan?code=3VCVnwZP1O&source=link)** - 推荐⭐⭐⭐⭐⭐
...
- **[cc-switch](https://github.com/farion1231/cc-switch)** - 快速切换不同AI模型配置
